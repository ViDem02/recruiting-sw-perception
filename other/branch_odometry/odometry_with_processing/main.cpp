...
main()
{
    const std::string file_name_1 = "first.pcd";
    const std::string file_name_2 = "second.pcd";
    ...
    reader.read<pcl::PointXYZ>(file_name_1, *original_cloud_1);
    reader.read<pcl::PointXYZ>(file_name_2, *original_cloud_2);
