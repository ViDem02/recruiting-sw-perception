...
Because opti libraries are easier to use in linux,
we'll use Docker. In particular, we'll setup CLion 
so that debugging will be made available 
also in the case of execution in the Docker container.