...
main()
{
    ...
    eucl_cluster_extr.setClusterTolerance(0.02); // 2cm
    eucl_cluster_extr.setMinClusterSize(100);
    eucl_cluster_extr.setMaxClusterSize(25000);
    eucl_cluster_extr.setSearchMethod(tree);
    eucl_cluster_extr.setInputCloud(cloud_filtered);
